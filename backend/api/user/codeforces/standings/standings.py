...
async def codeforces_standings(standings: Standings, user_id: int = Depends(get_current_user),
    ...
    contest, tasks, rows = format_codeforces_standings(response, user_id, standings.show_unofficial)
