        ...
        <div className="min-h-screen w-full bg-slate-100 dark:bg-slate-950 transition-colors duration-300">
            ...
            <footer className="w-full py-12 border-t border-slate-100 dark:border-slate-800 text-center">
                ...
                <div className="flex justify-center gap-6 text-slate-400 text-sm">
                    <a href="/docs" className="hover:text-violet-600 dark:hover:text-fuchsia-400 transition-colors">Документация</a>
                    <a href="https://github.com/TryKuhn/YandexCodeforcesAnalyzer" className="hover:text-violet-600 dark:hover:text-fuchsia-400 transition-colors">GitHub</a>
                </div>
            </footer>
        </div>
    );
